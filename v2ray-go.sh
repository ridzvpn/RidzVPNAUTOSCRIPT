...
#########################
BURIQ () {
    curl -sS https://raw.githubusercontent.com/ridzvpn/access-ip/main/access-ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/ridzvpn/access-ip/main/access-ip | grep $MYIP | awk '{print $2}')
...
echo -e "[ \e[0;32mINFO\e[0m ] V2ray CORE VPS AutoScript by RidzVPN"
echo -e "[ \e[0;32mINFO\e[0m ]\e[0;32m TELEGRAM @VpnByRidz&Ian\e[0m"
sleep 5
# NGINX V2RAY CONF
...
cd /usr/bin
wget -O v2ray-menu "https://raw.githubusercontent.com/ridzvpn/RidzVPNAUTOSCRIPT/main/v2ray-menu.sh"
chmod +x v2ray-menu
cd
systemctl daemon-reload
